...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full bg-white/5 border border-white/10 shadow-lg px-4 py-2 lg:flex dark:bg-black/10 dark:border-white/10",
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-white/10 backdrop-blur-md border border-white/10",
        className,
      )}
    >
      {React.Children.map(children, (child) =>
